...
data_path = '/data1/sigmagroup/yul/data/'
BATCH_SIZE = 128
...
x_x0,x_x1,x_y0,x_y1,c_x0,c_x1,c_y0,c_y1 = att_utils.load_test_data(data_path)
print('data ready ...')
model = net.build(x_x0.shape,x_x1.shape[1],8,16,100,act_1='relu',act_2='sigmoid',loss_function='binary_crossentropy')
#model = net.build(x_x0.shape,x_x1.shape[1],2,act_1='relu',act_2=None,loss_function=mAP.my_loss)
#model = net.build(x_x0.shape,x_x1.shape[1],act_1='relu',act_2=None,loss_function=mAP.my_loss)
max_ = (0,0,0,'None')
