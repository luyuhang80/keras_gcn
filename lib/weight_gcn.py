...
class MyLayer(Layer):
    ...
    def build(self, input_shape):
        ...
        self.w_layers = self.add_weight(name='w_layers',shape=([self.num_layers,1]),initializer='uniform',trainable=True)
    ...
    def build_graph(self):
        filename = '/data1/sigmagroup/yul/data/knn_graph.txt'
